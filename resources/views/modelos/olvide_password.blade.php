...
<head>
    ...
    <title>Recuperar Cuenta Models | SeduxaModels</title>
...
<body>
    ...
    <div class="wrap">
        ...
        <div class="topbar">
            <h1>Recuperar Cuenta Models</h1>
        </div>

        <div class="card">
            <p>
                Si eres Model y olvidaste tu contraseña, completa los datos reales.
                Nuestro equipo se contactará por WhatsApp o correo para validar tu identidad.
            </p>

            <!-- ID OPCIONAL -->
            <label>ID (opcional)</label>
            <input id="modelId" placeholder="Ej: MD-20491">
